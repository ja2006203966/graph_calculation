...
#     return  x 
##=======================================================================================================
def edge_conv(points, ptw, features, num_points, K, channels, w = -1, with_bn=True, activation='relu', pooling='average', name='edgeconv'):
    """EdgeConv
    Args:
...
#                             pooling=setting.conv_pooling, name='%s_%s%d' % (name, 'EdgeConv2', layer_idx)) 
            ...
            fts = edge_conv(pts, tf.expand_dims(fts[:, :, -1], axis = -1), fts, setting.num_points, K, channels, w = w,with_bn=True, activation='relu',
